...
const DOMAINS: CreatorOpsDomain[] = [
  ...
  },
  {
    ...
    description:
      "Run prompts, templates, playbooks, AI generation, and copilot workflows.",
    icon: Sparkles,
    homeHref: "/runner",
    matchRoutes: [
      "/prompts",
  ...
  },
  {
    ...
    icon: ShoppingBag,
    homeHref: "/product-listings",
    matchRoutes: ["/merch-ideas", "/product-listings", "/mockup-prompts"],
    navItems: [
  ...
  },
  {
    ...
    matchRoutes: ["/social-repurposing", "/email-campaigns"],
    navItems: [
      { label: "Product Listings", href: "/product-listings", icon: ShoppingBag },
      { label: "Merch Ideas", href: "/merch-ideas", icon: Shirt },
      { label: "Integrations", href: "/integrations", icon: Link2 },
    ...
    relatedItems: [
      { label: "Product Factory", href: "/product-listings", icon: ShoppingBag },
      { label: "Assets", href: "/assets", icon: FolderOpen },
    ],
  },
  {
    ...
    icon: BarChart3,
    homeHref: "/analytics",
    matchRoutes: ["/analytics", "/patterns", "/quality-performance", "/experiments", "/quality", "/learnings"],
    navItems: [
      { label: "Analytics", href: "/analytics", icon: BarChart3 },
